...
class HComponent extends HLinkedList{
    ...
    constructor(name,id){
        ...
        this.id = id;
        document.styleSheets[0].addRule(name +"."+ id,"" );
...
let BackgroundImage = function (url){ return new HBackgroundImage(url)};
...
let BottomBorder = function (width = BORDERWIDTH.THICK,style =BORDERSTYLE.SOLID,color="BLACK", unit= _UNITS.PERCENTILE){ return new HBottomBorder(width ,style ,color, unit)};
...
let Cursor = function (cursor = CURSOR.AUTO){ return new HCursor(cursor)};
...
let FontSize = function (size = 3, unit = _UNITS.PERCENTILE){ return new HFontSize(size , unit )};
...
let Label = function (id, name='',For){ return new HLabel(id, name,For)};
...
let TextInput = function (id, name='',maxLength){ return new HTextInput(id, name,maxLength)};
