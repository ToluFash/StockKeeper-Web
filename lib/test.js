...
let firstNameLabel =  Label('','','firstNameInput').setTextContent('First Name:');
...
let lastNameLabel =  Label('','','lastNameInput').setTextContent('Last Name:');
...
let dobLabel =  Label('','','dobInput').setTextContent('Date of Birth:');
...
let incomeLabel =  Label('','','incomeInput').setTextContent('Income:');
incomeDiv
...
let detailsLabel =  Label('','','detailsInput').setTextContent('Tell us About Yourself:');
...
let passwordLabel =  Label('','','passwordInput').setTextContent('Password:');
